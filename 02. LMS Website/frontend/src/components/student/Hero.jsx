...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-fuchsia-200/70'>
      <h1 className='md:text-[38px] text-[28px] relative font-bold text-gray-800 max-w-3xl mx-auto'>Unlock your full potential with hands-on learning and personalized <span className='text-fuchsia-700'>expert guidance.</span><img src={assets.sketch2} alt="sketch" className='md:block hidden absolute -bottom-7 right-0 w-60'/></h1>
