  ...
  return (
    <div className='text-center'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border-1 border-gray-300 rounded-sm'>
        <input className='w-full sm:flex-1 outline-none px-1' type="email" placeholder='Enter your email' required/>
        <button className='bg-black text-white text-base px-10 py-3 rounded-sm cursor-pointer' type='submit'>
          Subscribe
        </button>
      </form>
    </div>
