      ...
      <div>
        {
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className='py-4 border-t text-gray-700 grid grid-cols-[4fr_0.5fr_05.fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
