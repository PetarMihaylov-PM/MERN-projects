    ...
    <div className='min-h-screen flex items-center justify-center w-full'>
      <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <button className='mt-2 w-full py-2 px-4 rounded-md text-white bg-black cursor-pointer hover:bg-gray-800 duration-150 ease-in-out' type='submit'>Login</button>
        </form>
      </div>
    </div>
  )
